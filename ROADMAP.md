...
- [ ] No known P0/P1 defect remains; lower-priority work is documented and
  assigned beyond 0.12 where appropriate.
- [ ] The public API fingerprint is frozen and approved.
- [ ] Three-OS CI, managed-only verification, package inspection, source
  archive, and consumer smoke pass.
- [ ] RC package and release notes accurately identify prerelease status.
- [ ] The stable-release checklist is ready.
