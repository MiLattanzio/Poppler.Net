                ...
                "intentional_raster_changes_0_12_0_alpha_1": [
                    {
                        "page": 1,
                        "reason": (
                            "Butt, round and square caps now come from transformed "
                            "user-space stroke outlines."
                        ),
                    },
                    {
                        "page": 5,
                        "reason": (
                            "Miter, round and bevel joins now share the outline fill "
                            "scan converter and enforce the miter limit before the CTM."
                        ),
                    },
                ],
            },
